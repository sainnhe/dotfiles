...
() {
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#72cce8}${p}%f"
    local err="%F{#ff6578}${p}%f"
  else
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
      typeset -g POWERLEVEL9K_RULER_FOREGROUND='#181a1c'
    else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#f69c5e'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#9dd274'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#9dd274'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#ff6578'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#72cce8'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#eacb64'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#ba9cf3'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#828a9a'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#ff6578'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#828a9a'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#72cce8'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#ff6578'
  else
