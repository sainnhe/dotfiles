...
() {
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#81d0c9}${p}%f"
    local err="%F{#f86882}${p}%f"
  else
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
      typeset -g POWERLEVEL9K_RULER_FOREGROUND='#1f1e1c'
    else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#f08d71'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#a6cd77'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#a6cd77'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#f86882'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#81d0c9'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#f0c66f'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#9fa0e1'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#937f78'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#f86882'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#937f78'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#81d0c9'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#f86882'
  else
