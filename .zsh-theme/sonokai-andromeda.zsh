...
() {
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#6dcae8}${p}%f"
    local err="%F{#fb617e}${p}%f"
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#f89860'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#9ed06c'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#9ed06c'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#fb617e'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#6dcae8'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#edc763'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#bb97ee'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#7e8294'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#fb617e'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#7e8294'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#6dcae8'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#fb617e'
  else
