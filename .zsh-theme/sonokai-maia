...
() {
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#78cee9}${p}%f"
    local err="%F{#f76c7c}${p}%f"
  else
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
      typeset -g POWERLEVEL9K_RULER_FOREGROUND='#1c1e1f'
    else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#f3a96a'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#9cd57b'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#9cd57b'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#f76c7c'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#78cee9'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#e3d367'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#baa0f8'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#82878b'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#f76c7c'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#82878b'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#78cee9'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#f76c7c'
  else
