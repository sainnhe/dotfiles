...
() {
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#e2cca9}${p}%f"
    local err="%F{#f2594b}${p}%f"
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#f28534'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#8bba7f'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#b0b846'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#f2594b'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#80aa9e'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#e9b143'
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#f2594b'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#f28534'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#f2594b'
  else
