...
() {
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#b05ccc}${p}%f"
    local err="%F{#d05858}${p}%f"
  else
    local ok="%F{$(_pp_s 005 134)}${p}%f"
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
      typeset -g POWERLEVEL9K_RULER_FOREGROUND='#e6eaee'
    else
      typeset -g POWERLEVEL9K_RULER_FOREGROUND=$(_pp_c 7 247)
    fi
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#3a8b84'
  else
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR=$(_pp_c 006 73)
  fi
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#3a8b84'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#608e32'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#d05858'
  else
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND=$(_pp_c 006 73)
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND=$(_pp_c 002 107)
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND=$(_pp_c 001 167)
  fi
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#5079be'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#be7e05'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#b05ccc'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#8790a0'
  else
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=$(_pp_c 004 68)
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=$(_pp_c 003 172)
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=$(_pp_c 005 134)
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=$(_pp_c 007 247)
  fi
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#d05858'
  else
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#8790a0'
  else
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$(_pp_c 007 247)
  fi
  ...
  if [[ "$ICE_AGE_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#5079be'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#d05858'
  else
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND=$(_pp_c 004 68)
