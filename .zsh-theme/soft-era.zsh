...
() {
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    local ok="%F{#f165bd}${p}%f"
    local err="%F{#ec9157}${p}%f"
  else
  ...
  if (( ${PURE_POWER_USE_P10K_EXTENSIONS:-1} )); then
    ...
    if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
      typeset -g POWERLEVEL9K_RULER_FOREGROUND='#dfc5c5'
    else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_VISUAL_IDENTIFIER_COLOR='#ec9157'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_DIR_{ETC,DEFAULT}_FOREGROUND='#25b7b8'
    typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER}_FOREGROUND='#96ad01'
    typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FOREGROUND='#f165bd'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#75a9d9'
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#ec9157'
    typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#aea6e1'
    typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#dfc5c5'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#f165bd'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#dfc5c5'
  else
  ...
  if [[ "$DESERT_NIGHT_PURE_POWER_TRUE_COLOR" == "true" ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,REMOTE_SUDO,REMOTE,SUDO}_FOREGROUND='#ec9157'
    typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#f165bd'
  else
